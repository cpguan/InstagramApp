...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let configuration = ParseClientConfiguration {
            $0.applicationId = "iOSInstagram"
            $0.server = "https://ancient-castle-50514.herokuapp.com/parse"
            $0.clientKey = "sdjvajlsaoenoiabw3090tu43bjIOIEF090u4tjjE84ns&kkske77367egdb8k"  // set to nil assuming you have not set clientKey
        }
